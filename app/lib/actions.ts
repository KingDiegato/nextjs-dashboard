...
const FormSchema = z.object({
    id: z.string(),
    customerId: z.string(handlingFormErrors.customerIdError),
    amount: z.coerce.number().gt(0, handlingFormErrors.amountError),
    status: z.enum(['pending', 'paid'], handlingFormErrors.statusError),
    date: z.string()
})
